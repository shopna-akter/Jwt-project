        ...
        <div>
            ...
            >
                <SwiperSlide>
                    ...
                    <img src="https://i.ibb.co/N66bPz9/h1.jpg" alt="" className="w-full md:h-[500px] h-[300px]" />
                </SwiperSlide>
                <SwiperSlide>
                    <div className="text-white absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                    ...
                    <img src="https://i.ibb.co/nfxZxG9/h2.jpg" alt="" className="w-full md:h-[500px] h-[300px]" />
                </SwiperSlide>
                <SwiperSlide>
                    <div className="text-white absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                        <h1 className="md:text-4xl text-xl font-bold text-center lg:text-left"><Typewriter
